...
def ocorrencia():
    ...
    ocorrencias = {
        ...
        'Comandante da guarnição': input('Comandante da guarnição: ').upper(),
        ...
        'Fatal' : input('Houve ocorrência fatal? S/N: ').upper(),
        ...
        'Ocorrências sem envolvimento com trânsito' : input('Houve registros alheios à trânsito? S/N: ').upper(),
        'Receptação': 0,
        'Uso e consumo' : 0,
        'Tráfico de drogas' : 0,
    ...
    ocorrencias['Pontuacao TIP'] = ocorrencias['Quantidade de TIP'] * 3

    if (ocorrencias['Fatal']).upper() == 's':
    ...
    elif (ocorrencias['Fatal']).upper() == 'n':
        ocorrencias['Quantidade de ocorrências com vítimas fatais'] = 0

    if ocorrencias['Número de integrantes da guarnição'] == 2:
        ocorrencias[ 'Integrante da guarnição 2'] = input('Integrante da guarnição: ').upper()
    elif ocorrencias['Número de integrantes da guarnição'] == 3:
        ocorrencias[ 'Integrante da guarnição 2'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 3'] = input('Integrante da guarnição: ').upper()
    elif ocorrencias['Número de integrantes da guarnição'] == 4:
        ocorrencias[ 'Integrante da guarnição 2'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 3'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 4'] = input('Integrante da guarnição: ').upper()
    elif ocorrencias['Número de integrantes da guarnição'] == 5:
        ocorrencias[ 'Integrante da guarnição 2'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 3'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 4'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 5'] = input('Integrante da guarnição: ').upper()
    elif ocorrencias['Número de integrantes da guarnição'] == 6:
        ocorrencias[ 'Integrante da guarnição 2'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 3'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 4'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 5'] = input('Integrante da guarnição: ').upper()
        ocorrencias[ 'Integrante da guarnição 6'] = input('Integrante da guarnição: ').upper()
...
while True:
    ...
    comando = input('Iniciar, Continuar ou Finalizar: ')
    
    if comando.lower() == 'iniciar' or comando.lower() == 'continuar':

        ocorrencias = ocorrencia()

        lista_ocorrencia.append(ocorrencias)

    elif comando.lower() == 'finalizar':
